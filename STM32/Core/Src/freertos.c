...
osThreadId task_bilge_pumpHandle;
osSemaphoreId decoder_semHandle;
...
extern void StartTaskCommunication(void const * argument);
extern void Start_Task_PumpControl(void const * argument);
